...
| 2. Translating plot summaries | `data/summaries/<locale>.json` | 80 titles, ~15,000 words | English complete; 11 translations complete, unreviewed |
...
| --- | --- | --- | --- |
| Español (es) | 80/80 | 简体中文 (zh-Hans) | 80/80 |
